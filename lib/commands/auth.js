...
async function githubAuthCommand(context, vscode, log, isDebugMode) {
    const input = await vscode.window.showInputBox({
        prompt: 'Paste your SlashCoded refresh token (from browser after GitHub auth)',
        ignoreFocusOut: true,
        password: true,
    ...
    if (ok) vscode.window.showInformationMessage('SlashCoded upload token updated successfully.');
